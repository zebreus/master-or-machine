...
export type EarlyChristianArtAndArchitecture = {
  image: string
...
const earlyChristianArtAndArchitecture: EarlyChristianArtAndArchitecture =
  [] satisfies EarlyChristianArtAndArchitecture

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default earlyChristianArtAndArchitecture
