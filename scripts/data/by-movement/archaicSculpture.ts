...
const archaicSculpture: ArchaicSculpture = [
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/9/94/009MA_Kritios.jpg",
    paintingLabel: "Kritios Boy",
    artistName: "Critius",
    date_of_birth: "-600",
    date_of_death: "-500",
    image_of_artist:
      "https://upload.wikimedia.org/wikipedia/commons/4/49/ACMA_698_Kritios_boy_4.JPG",
    movementLabel: "archaic sculpture",
    height: "120",
    description: "ancient Greek sculpture from the Acropolis of Athens",
    abstract:
