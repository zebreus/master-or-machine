...
export type ClassicalGreekSculpture = {
  image: string
...
const classicalGreekSculpture: ClassicalGreekSculpture = [
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/b/b6/Hermes_di_Prassitele%2C_at_Olimpia%2C_front.jpg",
    paintingLabel: "Hermes and the Infant Dionysus",
    ...
    height: "215",
    description: "sculpture by Praxiteles",
    abstract:
  ...
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/2/26/Dor%C3%ADforo-compara%C3%A7%C3%A3o.jpg",
    paintingLabel: "Doryphoros",
    artistName: "Polykleitos the Elder",
    date_of_birth: "-450",
    date_of_death: "-500",
    image_of_artist:
      "https://upload.wikimedia.org/wikipedia/commons/4/4f/Diadoumenos-Atenas.jpg",
    movementLabel: "classical Greek sculpture",
    height: "212",
    description: "lost statue by Polykleitos / type of statue",
    abstract:
