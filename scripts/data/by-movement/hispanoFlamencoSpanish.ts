...
export type HispanoFlamencoSpanish = {
  image: string
...
const hispanoFlamencoSpanish: HispanoFlamencoSpanish =
  [] satisfies HispanoFlamencoSpanish

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default hispanoFlamencoSpanish
