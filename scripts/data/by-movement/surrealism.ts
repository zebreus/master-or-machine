...
const surrealism: Surrealism = [
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/f/fd/Lobster_Telephone_Photo.jpg",
    paintingLabel: "Lobster Telephone",
    ...
    width: "330",
    height: "178",
    description: "Skulptur von Salvador Dalí (German)",
    abstract:
  ...
  },
  {
    ...
    image_of_artist:
      "https://upload.wikimedia.org/wikipedia/commons/2/27/Salvador_Dali_NYWTS.jpg",
    movementLabel: "Surrealism",
    description: "painting by Salvador Dalí",
  },
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/b/bc/Casa_de_La_Moneda._Donaci%C3%B3n_botero.jpg",
    paintingLabel: "The Beautiful Night",
    artistName: "Paul Delvaux",
    date_of_birth: "1897",
    date_of_death: "1994",
    image_of_artist:
      "https://upload.wikimedia.org/wikipedia/commons/0/06/Willy_Bosschem247.jpg",
    movementLabel: "Surrealism",
    description: "painting by Paul Delvaux",
  },
  {
    image:
  ...
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/2/25/London_Dali_Exhibition.jpg",
