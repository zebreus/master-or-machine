...
const pontAvenSchool: PontAvenSchool = [
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/5/5e/Paul_Gauguin_137.jpg",
    paintingLabel: "Vision After the Sermon",
    ...
    width: "91.00",
    height: "72.20",
    description: "oil painting by French artist Paul Gauguin",
    abstract:
  ...
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/5/54/Paul_Gauguin_016.jpg",
    paintingLabel: "Paysannes bretonnes",
    artistName: "Paul Gauguin",
    date_of_birth: "1848",
    date_of_death: "1903",
    image_of_artist:
