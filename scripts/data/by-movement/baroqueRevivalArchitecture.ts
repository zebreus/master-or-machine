...
export type BaroqueRevivalArchitecture = {
  image: string
...
const baroqueRevivalArchitecture: BaroqueRevivalArchitecture =
  [] satisfies BaroqueRevivalArchitecture

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default baroqueRevivalArchitecture
