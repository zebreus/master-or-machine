...
export type AncientRomanMuralPainting = {
  image: string
...
const ancientRomanMuralPainting: AncientRomanMuralPainting =
  [] satisfies AncientRomanMuralPainting

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default ancientRomanMuralPainting
