...
const hskpaalclugibzepegpk: Hskpaalclugibzepegpk = {
  ...
  prompt:
    "a painting of a crowd of people in a park, an impressionist painting by Renoir, featured on pixiv, post-impressionism, impressionism, fauvism, creative commons attribution, with a focus on the vibrant colors and loose brushstrokes that characterize Renoir's work",
  result: 1,
