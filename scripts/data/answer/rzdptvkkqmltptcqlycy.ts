...
const rzdptvkkqmltptcqlycy: Rzdptvkkqmltptcqlycy = {
  ...
  prompt:
    "Painting in the style of Claude Monet.  A group of three women sit together on a bench in a lush, verdant garden, surrounded by flowers, trees, and a serene pond",
  result: 0,
