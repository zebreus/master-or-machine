...
export type NeoclassicalArchitecture = {
  image: string
...
const neoclassicalArchitecture: NeoclassicalArchitecture = [
  {
    image:
      "https://upload.wikimedia.org/wikipedia/commons/2/2b/Le%C3%B3nidas_en_las_Term%C3%B3pilas%2C_por_Jacques-Louis_David.jpg",
    paintingLabel: "Leonidas at Thermopylae",
