...
export type RomanesqueArtInCatalonia = {
  image: string
...
const romanesqueArtInCatalonia: RomanesqueArtInCatalonia =
  [] satisfies RomanesqueArtInCatalonia

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default romanesqueArtInCatalonia
