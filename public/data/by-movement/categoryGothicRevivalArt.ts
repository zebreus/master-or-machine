...
export type CategoryGothicRevivalArt = {
  image: string
...
const categoryGothicRevivalArt: CategoryGothicRevivalArt =
  [] satisfies CategoryGothicRevivalArt

// Export as default value to avoid a weird bug where json files are sometimes preferred over ts files
export default categoryGothicRevivalArt
