...
const vdchzmbekpibpjxaaoix: Vdchzmbekpibpjxaaoix = {
  ...
  artwork: {
    ...
    motifs: ["horse", "Stanisław Kostka Potocki", "equestrianism"],
    genres: ["equestrian portrait"],
    materials: ["oil paint", "canvas"],
  },
  prompt:
    "a painting of a man riding a horse, an ultrafine detailed painting by Jacques-Louis David, behance, rococo, rococo, flemish baroque, detailed painting",
  result: 1,
