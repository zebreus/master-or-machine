...
const rusvbdxmhriguybbaupq: Rusvbdxmhriguybbaupq = {
  ...
  prompt:
    "a painting of a woman with a red hat, a character portrait by Egon Schiele, pinterest, barbizon school, pre-raphaelite, academic art, studio portrait, the background is a dark green color, the woman is wearing a black dress, the woman is holding a white handkerchief, the woman is looking at the viewer, the woman has a sad expression on her face, the woman has long brown hair, the woman is wearing a red hat, the woman is",
  result: 1,
