...
const oseknjdaoaycmezcietj: Oseknjdaoaycmezcietj = {
  ...
  prompt:
    "a painting of a snowy landscape with a fence and a magpie, an impressionist painting by Willard Metcalf, pixiv contest winner, american impressionism, impressionism, painterly, academic art",
  result: 0,
